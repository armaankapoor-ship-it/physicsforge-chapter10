# physicsforge-chapter10 - Wave Optics Visual Notes

A premium-style, zero-cost visual notes website for **NCERT Class 12 Physics Chapter 10: Wave Optics**.
...
Create a GitHub repository named `physicsforge-chapter10`, push this project, and use GitHub Pages from the `gh-pages` branch.

```bash
VITE_BASE_PATH=/physicsforge-chapter10/ pnpm build
```
